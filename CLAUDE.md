...
- **Classes:** 60 classes across all 10 genres, seeded with **no teacher, no day/time, no room** assigned. Each class has a `skillLevel` pre-assigned (`BI6` = Beg/Int (6-10), `BI10` = Beg/Int (10+), `IA6` = Int/Adv (6-10), `IA10` = Int/Adv (10+)). Skill levels are evenly distributed: **15 classes per level**. Duration distribution: 30 classes at 60 min; remaining 30 split across 30 min (5), 45 min (8), 75 min (8), 90 min (5), 105 min (2), 120 min (2). Mini/young classes → 30 min; beginners → 45 min; mid-advanced → 75 min; teen/team → 90 min; advanced technique → 105 min; top-level advanced → 120 min. Teen-prefixed classes are `BI10`; Elite/Company variants for younger students are `BI6` or `IA6` as appropriate.
